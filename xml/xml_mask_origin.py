...
product_list = set(['folgers','crayola','kleenex','viva','vanish','milo','swissmiss','cocacola','raisins','mm','andes','pocky','kotex','macadamia','stax','kellogg','hunts','3m','heineken','libava'])
        ...
        if type(label_dict['annotation']['object']).__name__ != "list":
            try:
                ...
                if object_['name'] in product_list and object_['deleted'] == '0':
                    ...
                    cv2.fillConvexPoly(mask, poly_vertice, 255)
